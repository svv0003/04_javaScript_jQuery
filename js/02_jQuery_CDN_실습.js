...
$(function () {
  // 2번 : id가 btn인 요소를 클릭했을 때 실행될 함수를 정의
  // $("#btn").click(function () {                  // 익명함수 this 함수 사용 가능!!
  $("#btn").click(() => {                           // 익명함수 화살표 함수 사용 가능!!
    // 3번 : 텍스트 변경 - id가 title인 요소의 텍스트를 변경
    $("#title").text("버튼이 클릭되었습니다.");
    // 4번 : id가 description인 요소를 0.5초간 숨겼다가 다시 0.5초간 나타나는 메소드 사용
